...
const HRDashboard = ({ onNavigate, setIsLoggedIn }) => {
    ...
    // Guard: ensure HR only lands on allowed tabs
    const HR_ALLOWED_TABS = ['dashboard', 'analytics', 'users', 'walk-in', 'news', 'profile', 'settings', 'notifications'];
    useEffect(() => {
        if (!HR_ALLOWED_TABS.includes(activeTab)) {
            ...
            <main className="main-content">
                <header className="main-header">
                        ...
                        <div className="header-title">
                            ...
                            <p>
                                {(activeTab === 'users' || activeTab === 'analytics')
                                    ? 'Manage your HR configurations and data'
                                    : `Welcome back, ${adminProfile.name || 'HR Manager'}`}
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="header-right">
                        {adminProfile.branch && (
                            <div className="branch-badge" title={adminProfile.branch}>
                                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                                    <path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"></path>
                                    <circle cx="12" cy="10" r="3"></circle>
                                </svg>
                                <span>{formatBranchName(adminProfile.branch)}</span>
                            </div>
                        )}
