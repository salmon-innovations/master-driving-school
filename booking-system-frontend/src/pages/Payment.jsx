        ...
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-4xl mx-auto mb-8 sm:mb-12" data-aos="fade-down">
            <div className="flex items-center justify-between relative">
              <div className="absolute top-5 left-0 right-0 h-1 bg-gray-200 rounded-full -z-10">
                <div className={`h-full bg-gradient-to-r from-[#2157da] to-blue-600 rounded-full transition-all duration-500 ${
                  !paymentType ? 'w-0' : !paymentMethod ? 'w-1/2' : 'w-full'
                }`}></div>
              </div>
              
              <div className="flex flex-col items-center">
                <div className={`w-10 h-10 rounded-full flex items-center justify-center font-black text-sm transition-all ${
                  paymentType ? 'bg-[#2157da] text-white shadow-lg' : 'bg-white border-2 border-gray-300 text-gray-400'
                }`}>
                  {paymentType ? '✓' : '1'}
                </div>
              ...
              <div className="flex flex-col items-center">
                <div className={`w-10 h-10 rounded-full flex items-center justify-center font-black text-sm transition-all ${
                  paymentMethod ? 'bg-[#2157da] text-white shadow-lg' : 'bg-white border-2 border-gray-300 text-gray-400'
                }`}>
                  {paymentMethod ? '✓' : '2'}
                </div>
              ...
              <div className="flex flex-col items-center">
                <div className={`w-10 h-10 rounded-full flex items-center justify-center font-black text-sm transition-all ${
                  (paymentType && paymentMethod) ? 'bg-[#2157da] text-white shadow-lg' : 'bg-white border-2 border-gray-300 text-gray-400'
                }`}>
                  3
                </div>
          ...
          <div className="max-w-6xl mx-auto grid lg:grid-cols-3 gap-6 lg:gap-8">
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <div className="bg-white p-6 sm:p-8 rounded-3xl shadow-lg border border-gray-100" data-aos="fade-right">
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                  ...
                  >
                    <div className="flex items-start justify-between mb-4">
                      <div className={`w-11 h-11 rounded-xl flex items-center justify-center ${
                        paymentType === "full" ? 'bg-[#2157da] shadow-lg' : 'bg-gray-100 group-hover:bg-blue-100'
                      }`}>
                        <svg className={`w-6 h-6 ${
                          paymentType === "full" ? 'text-white' : 'text-gray-400 group-hover:text-blue-600'
                  ...
                  >
                    <div className="flex items-start justify-between mb-4">
                      <div className={`w-11 h-11 rounded-xl flex items-center justify-center ${
                        paymentType === "downpayment" ? 'bg-[#2157da] shadow-lg' : 'bg-gray-100 group-hover:bg-blue-100'
                      }`}>
                        <svg className={`w-6 h-6 ${
                          paymentType === "downpayment" ? 'text-white' : 'text-gray-400 group-hover:text-blue-600'
                        }`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className={`bg-white p-6 sm:p-8 rounded-3xl shadow-lg border transition-all duration-500 ${
                !paymentType ? "opacity-40 pointer-events-none border-gray-200" : "opacity-100 border-gray-100"
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                  ...
                  <button 
                    ...
                    className={`group relative flex flex-col p-6 rounded-2xl border-2 transition-all duration-300 hover:shadow-lg ${
                      paymentMethod === "gcash" 
                  ...
                  >
                    <div className="flex items-center justify-between mb-4">
                      <div className={`w-14 h-14 rounded-2xl flex items-center justify-center transition-all ${
                        paymentMethod === "gcash" ? 'bg-[#007dfe] shadow-lg scale-110' : 'bg-[#007dfe]/10 group-hover:bg-[#007dfe]/20'
                      }`}>
                        <span className={`text-2xl font-black italic ${
                          paymentMethod === "gcash" ? 'text-white' : 'text-[#007dfe]'
                        }`}>G</span>
                      </div>
                      {paymentMethod === "gcash" && (
                  ...
                  >
                    <div className="flex items-center justify-between mb-4">
                      <div className={`w-14 h-14 rounded-2xl flex items-center justify-center transition-all ${
                        paymentMethod === "starpay" ? 'bg-[#ff4d00] shadow-lg scale-110' : 'bg-[#ff4d00]/10 group-hover:bg-[#ff4d00]/20'
                      }`}>
                        <span className={`text-xl font-black tracking-tighter ${
                          paymentMethod === "starpay" ? 'text-white' : 'text-[#ff4d00]'
                        }`}>★P</span>
                      </div>
                      {paymentMethod === "starpay" && (
                        <div className="w-7 h-7 bg-green-500 rounded-full flex items-center justify-center shadow-md">
              ...
              <div className="relative overflow-hidden bg-gradient-to-br from-[#2157da] via-[#1e4db7] to-[#0f1f4d] p-1 rounded-3xl shadow-2xl" data-aos="fade-up">
                ...
                <div className="relative bg-gradient-to-br from-[#2157da] via-[#1a3a8a] to-[#0f1f4d] p-6 sm:p-8 rounded-3xl">
                  <button 
                    className={`w-full py-5 rounded-2xl text-white font-black text-base sm:text-lg transition-all duration-300 relative overflow-hidden group ${
