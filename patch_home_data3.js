...
let effectStr = `    const fetchTestimonials = async () => {
      try {
...
content = content.replace(oldSeeAll1, newSeeAll);
content = content.replace(oldSeeAll2, newSeeAll);
...
console.log('Successfully completed Home data patch.');